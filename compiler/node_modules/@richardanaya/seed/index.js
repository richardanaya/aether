...
var EMPTY_BLOCK = exports.EMPTY_BLOCK = [64];
...
var GET_LOCAL = exports.LOCAL_GET = [32];
var SET_LOCAL = exports.LOCAL_SET = [33];
var TEE_LOCAL = exports.LOCAL_TEE = [34];
var GET_GLOBAL = exports.GLOBAL_GET = [35];
var SET_GLOBAL = exports.GLOBAL_SET = [36];
...
var EXPORT_FUNCTION = exports.EXPORT_FUNCTION = [0];
var EXPORT_TABLE = exports.EXPORT_TABLE = [1];
var EXPORT_MEMORY = exports.EXPORT_MEMORY = [2];
var EXPORT_GLOBAL = exports.EXPORT_GLOBAL = [3];
...
function makeSimple(inputs,outputs,code){
  ...
  let main_function_signature = [FUNC,vec(inputs),vec([outputs])] // function signature returns 42
